  ...
  <div class="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-md">
    ...
    <div class="flex gap-3 mb-6">
      ...
      <button
        ...
        class="px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg font-medium hover:from-blue-600 hover:to-blue-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
      >
