...
export class ApiClient {
   ...
   *
   * 支持单个 url 或 urls 数组。返回类型：
   *   - 单数：{ username, items, warning? }
   *   - urls：{ results: [{ username, items, warning?, url }] }
   */
  static async insCreatorLatest(params: InsCreatorLatestParams): Promise<any> {
